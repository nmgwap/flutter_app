  ...
  initState() {
    ...
    formList = [
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            "title": "FlatButton",
            "key": "一个扁平的Material按钮",
            "router": "listFlatButton"
          },
          {"title": "IconButton", "key": "一个Material图标按钮，点击时会有水波动画"},
          {
            "title": "PopupMenuButton",
            "key": "当菜单隐藏式，点击或调用onSelected时显示一个弹出式菜单列表"
          },
          ...
          {
            "title": "Chip",
            "key": "标签，一个Material widget。 它可以将一个复杂内容实体展现在一个小块中，如联系人"
          },
          {
            "title": "Tooltip",
            "key":
      ...
      },
      {
        ...
        "children": [
          ...
          },
          {
            ...
            "key": "一个iOS风格的页面的基本布局结构。包含内容和导航栏"
          },
          {
            "title": "CupertinoTabScaffold",
            "key": "标签式iOS应用程序的结构。将选项卡栏放在内容选项卡之上"
          },
          {
      ...
      },
      {
        "title": 'Layout',
        "children": [
          {"title": "Container", "key": "一个拥有绘制、定位、调整大小的 widget"},
          {"title": "Padding", "key": "一个widget, 会给其子widget添加指定的填充"},
          {"title": "Center", "key": "将其子widget居中显示在自身内部的widget"},
          {
            "title": "Align",
            "key": "一个widget，它可以将其子widget对齐，并可以根据子widget的大小自动调整大小"
          },
          ...
          },
          {
            ...
            "key": "一个widget，它将它的子widget的高度调整其本身实际的高度"
          },
          {
            "title": "IntrinsicWidth",
            "key": "一个widget，它将它的子widget的宽度调整其本身实际的宽度"
          },
          ...
          {"title": "Transform", "key": "在绘制子widget之前应用转换的widget"},
          {
            ...
            "key": "一个自定义的拥有单个子widget的布局widget"
          },
      ...
      },
      {
        ...
        "children": [
          {"title": "AnimatedContainer", "key": "在一段时间内逐渐改变其值的容器"},
          {
            ...
            "key": "一个widget，在两个孩子之间交叉淡入，并同时调整他们的尺寸"
          },
          ...
          {
            "title": "AnimatedSize",
            "key": "动画widget，当给定的孩子的大小变化时，它自动地在给定时间内转换它的大小"
          },
      ...
      for (var typeitem in item['children']) {
        typeList.add(
          ListTile(
            ...
            onTap: () {
              Navigator.pushNamed(context, typeitem['router']);
            },
          ),
        );
      }
